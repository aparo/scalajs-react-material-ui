...
object CustomIconSlider extends ScalaCssReactImplicits {
  ...
  class Backend(t: BackendScope[Props, State]) {
    ...
    def render(props: Props, state: State): VdomElement = {
      ...
      val iconSliderClasses = Map(
        MuiSlider.ClassKey.container -> styleAToClassName(css.slider),
        MuiSlider.ClassKey.thumbIconWrapper -> styleAToClassName(
          css.thumbIconWrapper
        )
      )
        ...
        ComponentContainer("Custom thumb")(
          div(
            ...
            MuiSlider(
              ...
              onChange = handleChange,
              thumb =
                MuiIcons(MuiIconsModule.Lens)()(style := js.Dictionary("color" -> "#fff"))().rawElement
            )(
  ...
  private val component = ScalaComponent
    .builder[Props]("CustomIconSlider")
    .initialState(State())
